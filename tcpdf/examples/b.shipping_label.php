...
for ($x = 1; $x <= $package; $x++) {
	...
	$pdf->Image('../../assets/image/logo-bnw.png', 7, 10.5, 33, 0, 'PNG', '', '', true, 1000, '', false, false, 0, false, false, false);
	$responsiveFont = 13;
	$headText = 13;
	ob_start();
	?>
	...
	<tr style="font-size: 9px; text-align: right;">
		<td>Progressive Medical Corporation<br>5 Calle Industria Bagumbayan<br>Quezon City 1110 Philippines</td>
	</tr>
	</table>
	<?php
	...
	$pdf->write2DBarcode('http://pmc.ph', 'QRCODE,H', 78, 127, 15, 15, $style, 'N');
