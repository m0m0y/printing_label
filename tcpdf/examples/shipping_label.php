...
for ($x = 1; $x <= $package; $x++) {
    ...
    $inmed_log = $pdf->Image('../../assets/image/logo-bnw.png', 15, 9, 38, 0, 'PNG', '', '', true, 1000, '', false, false, 0, false, false, false);
...
?>
	<table style="padding-right: 8px;">
		<tr style="font-size: 10px; text-align: left;">
			<td>Inmed Corporation 5 Calle Industria<br>Bagumbayan Quezon City 1110 Philippines<br><small>Email: mailto:wecare@inmed.com.ph</small></td>
		</tr>
	</table>
<?php
